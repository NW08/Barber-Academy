...
const Login: React.FC = () => {
  ...
  // isLoading viene del contexto (gestiona el estado de carga de la petición Axios)
  ...
  // Este efecto vigila <<isLoggedIn>>. En cuanto el contexto lo pone en true (tras login exitoso),
  // redirige al usuario.
  useEffect(() => {
    if (isLoggedIn) {
      navigate("/");
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // Delegamos la lógica al contexto
  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center overflow-hidden font-sans bg-black">
      ...
      >
        <div className="p-2 rounded-full bg-black/40 border border-white/10 group-hover:border-[#E69100]/50 backdrop-blur-sm transition-all">
          <svg
      ...
      <div className="relative z-10 w-full max-w-md p-8 mx-4">
        <div className="bg-black/80 border border-white/10 rounded-2xl shadow-2xl p-8 backdrop-blur-md transform transition-all duration-500 hover:shadow-[#E69100]/50 hover:shadow-2xl">
            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-gray-900/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#E69100] focus:ring-1 focus:ring-[#E69100] transition-all duration-300 transform focus:scale-[1.01]"
                />
              </div>
            </div>
