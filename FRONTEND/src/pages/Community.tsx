...
const Community: React.FC = () => {
  ...
  // Generar números aleatorios al montar el componente
  useEffect(() => {
    setStats({
      members: Math.floor(Math.random() * (120 - 40 + 1)) + 40,
      students: Math.floor(Math.random() * (80 - 20 + 1)) + 20,
      weekly: Math.floor(Math.random() * (15 - 5 + 1)) + 5,
    });
  }, []);

  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-black py-20 lg:py-32 flex flex-col items-center justify-center">
      {/* --- BACKGROUND CON EFECTO PARALLAX (Siempre visible para estética) --- */}
      ...
      {/* --- LÓGICA CONDICIONAL --- */}
      {isLoggedIn ? (
        // CASO 1: USUARIO LOGUEADO (Muestra  el contenido)
        <div className="container relative z-10 px-4 mx-auto text-center animate-in fade-in zoom-in-95 duration-700">
          {/* --- HEADER --- */}
          <div className="mb-16 md:mb-24">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              No estás solo en este camino. Conéctate con otros barberos,
              comparte tu progreso y accede a eventos exclusivos.
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <a
                    ...
                    hover:text-white transition-all duration-300 block"
                  >
                    Unirme Ahora
                  </a>
                </div>
        ...
        // CASO 2: USUARIO NO LOGUEADO (Muestra AuthGuard)
        // Usamos un contenedor z-10 para asegurar que esté sobre el fondo
