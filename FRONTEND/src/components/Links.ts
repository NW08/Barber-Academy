// Definimos la interfaz para cada enlace
import {
  benefitIcon1,
  benefitIcon2,
  benefitIcon3,
...
// Iconos asociados (importados desde assets)
...
export type RoadmapStatus = "done" | "progress";
...
export const collabContent: CollabItem[] = [
